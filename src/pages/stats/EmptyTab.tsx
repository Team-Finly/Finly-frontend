...
const EmptyTab = ({ status, recordCount = 0 }: Props) => {
  ...
  return (
    <div className="flex w-full flex-1 flex-col items-center gap-6 px-4">
      ...
      <div
        ...
        className="bg-secondary content-fit flex cursor-pointer items-center justify-center rounded-[8px] px-3 py-2"
      >
